...
/**
*      自 cURL 7.15.5 起删除；请改用 <strong><code>CURLOPT_RETURNTRANSFER</code></strong>。     
*/
...
/**
*      当启用 <a href="https://www.php.net/manual/zh/ini.core.php#ini.open-basedir" class="link">open_basedir</a> 时，此常量不可用。     
*/
...
/**
*      自 cURL 7.10.8 起，这是 <strong><code>CURLINFO_RESPONSE_CODE</code></strong> 的旧别名     
*/
