...
/**
*      在 <a href="https://www.php.net/manual/zh/ini.core.php#ini.include-path" class="link">include_path</a> 里搜索 <code class="parameter">filename</code>。     
*/
...
/**
*      文本模式。      <blockquote class="note"><p><strong class="note">注意</strong>:        <p class="para">        此常量无效，仅仅用于向后兼容（<code class="literal">forward compatibility</code>）。       </p>      
*/
define('FILE_TEXT', 0);

/**
*      二进制模式。      <blockquote class="note"><p><strong class="note">注意</strong>:        <p class="para">        此常量无效，仅仅用于向后兼容（<code class="literal">forward compatibility</code>）。       </p>      
*/
...
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持基于 DES 的标准散列。始终是 <code class="literal">1</code>。     
*/
define('CRYPT_STD_DES', 1);
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持基于 DES 的扩展散列。始终是 <code class="literal">1</code>。     
*/
define('CRYPT_EXT_DES', 1);
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持 MD5 散列。始终是 <code class="literal">1</code>。     
*/
define('CRYPT_MD5', 1);
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持 Blowfish 散列。始终是 <code class="literal">1</code>。     
*/
define('CRYPT_BLOWFISH', 1);
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持 SHA-256 散列。始终是 <code class="literal">1</code>。     
*/
define('CRYPT_SHA256', 1);
/**
*      表示 <span class="function">{@link crypt()}</span> 是否支持 SHA-512 散列。始终是 <code class="literal">1</code>。     
*/
...
/**
*     <strong><code>SORT_LOCALE_STRING</code></strong> 基于当前区域来对对象进行字符串比较。     
*/
define('SORT_LOCALE_STRING', 5);

/**
*      <strong><code>CASE_LOWER</code></strong> 用在      <span class="function">{@link array_change_key_case()}</span> 中将数组的键名转换成小写字母。这也是      <span class="function">{@link array_change_key_case()}</span> 的默认值。从 PHP 8.2.0 开始，只转换 ASCII 字符。     
*/
define('CASE_LOWER', 0);

/**
*      <strong><code>CASE_UPPER</code></strong> 用在      <span class="function">{@link array_change_key_case()}</span> 中将数组的键名转换成大写字母。从 PHP 8.2.0 开始，只转换 ASCII 字符。     
*/
define('CASE_UPPER', 1);
...
/**
*&raquo;&nbsp;<code class="literal">Operating System Names</code>
*/
...
/**
*      根据 <a href="http://www.faqs.org/rfcs/rfc1738" class="link external">&raquo;&nbsp;RFC 1738</a> 和 <code class="literal">application/x-www-form-urlencoded</code>      媒体类型执行编码，这意味着空格会编码为加号（<code class="literal">+</code>）。     
*/
define('PHP_QUERY_RFC1738', 1);
/**
*       根据 <a href="http://www.faqs.org/rfcs/rfc3986" class="link external">&raquo;&nbsp;RFC 3986</a> 执行编码，空格将会百分比编码（<code class="literal">%20</code>）。     
*/
...
/**
*      包含着会话名以及会话 ID 的常量，格式为      <code class="literal">&quot;name=ID&quot;</code>，或者如果会话 ID 已经在适当的会话      cookie 中设定时则为空字符串。      这和 <span class="function">{@link session_id()}</span> 返回的是同一个 ID。     
*/
define('SID', "name=ID");
/**
*      如果会话已禁用则返回 <span class="function">{@link session_status()}</span> 的值。     
*/
define('PHP_SESSION_DISABLED', 0);
/**
*      在会话已启用但是没有会话的时候返回 <span class="function">{@link session_status()}</span> 的值。     
*/
define('PHP_SESSION_NONE', 1);
/**
*      在一个会话已启用并存在时返回  <span class="function">{@link session_status()}</span> 的值。     
*/
...
/**
*     <strong><code>SORT_NATURAL</code></strong> 用于对元素作为字符串使用“自然排序”（像是 <span class="function">{@link natsort()}</span>     ）比较。     
*/
define('SORT_NATURAL', 6);
/**
*     <strong><code>SORT_FLAG_CASE</code></strong> 可以跟 <strong><code>SORT_STRING</code></strong> 或者 <strong><code>SORT_NATURAL</code></strong>      组合（按位或（OR））对字符串进行大小写不敏感排序。从 PHP 8.2.0 开始，只转换 ASCII 字符。     
*/
